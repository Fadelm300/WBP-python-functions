...
def generate_froyo_receipt(customer_name, size, base_price, *flavors, order_type='Dine In', **toppings):
  print('-'*35)
  print(f'{order_type} order for', customer_name)
  print('-'*35)

  print(f'{size} froyo:', ' / '.join(flavors))
  ...
  print(f'Price: ${total_price:0.2f}')
  print('-'*35)
  print()
